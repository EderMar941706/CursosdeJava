...
public class Ejemplo6D{
    ...
    public Ejemplo6D(int id, double baseCost, int allottedMinutes, int minutesUsed){
        this.id = id;
    ...
    public void printItemizedBill(){
        ...
        System.out.println("Tarifa Base: $" + baseCost);
        System.out.println("Tarifa por Excederte: $"
